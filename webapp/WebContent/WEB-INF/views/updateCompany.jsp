...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="/webapp/CompanyMenu?nombre=${nombre}&page=${page}&sort=${sort}&search=${search}"> Application - Company Database </a>
        </div>
    </header>
    <section id="main">
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="/webapp/UpdateCompany" method="POST">
                        ...
                        <div class="actions pull-right">
                            ...
                            or
                            <a href="/webapp/CompanyMenu?nombre=${nombre}&page=${page}&sort=${sort}&search=${search}" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
