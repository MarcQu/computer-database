    ...
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div style="float: right;">
            	<a href="/webapp/CompanyMenu?nombre=${nombre}&page=${page}&search=${search}&sort=${sort}&lang=en">English</a> | <a href="/webapp/CompanyMenu?nombre=${nombre}&page=${page}&search=${search}&sort=${sort}&lang=fr">Français</a>
            </div>
        </div>
    </header>
