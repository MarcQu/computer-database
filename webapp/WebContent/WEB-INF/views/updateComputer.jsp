...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="/webapp/ComputerMenu?nombre=${nombre}&page=${page}&sort=${sort}&search=${search}"> Application - Computer Database </a>
        </div>
    </header>
    <section id="main">
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="/webapp/UpdateComputer" method="POST">
                        ...
                        <div class="actions pull-right">
                            ...
                            or
                            <a href="/webapp/ComputerMenu?nombre=${nombre}&page=${page}&sort=${sort}&search=${search}" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
