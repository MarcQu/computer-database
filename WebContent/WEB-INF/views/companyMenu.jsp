                    ...
                    <tr>
                        ...
                        <th class="editMode" style="width: 60px; height: 22px;">
                            ...
                            <span style="vertical-align: top;">
	                            <a href="/Computer-database/DeleteCompany?nombre=${nombre}&page=${page}&search=${search}&sort=${sort}" id="deleteSelected" onclick="deleteCompany();">
                ...
                <tbody id="results">
                	<c:forEach var="company" items="${companies}">
						<tr>
	                        ...
	                        <td>
	                            <a href="/Computer-database/UpdateCompany?companyId=${company.getId()}&nombre=${nombre}&page=${page}&search=${search}&sort=${sort}" onclick=""><c:out value="${company.getName()}"/></a>
	                        </td>
						</tr>
                	</c:forEach>
                </tbody>
