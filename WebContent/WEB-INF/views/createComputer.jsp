...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="/Computer-database/ComputerMenu?nombre=10&page=1&sort=asc&search="> Application - Computer Database </a>
        </div>
    </header>
                ...
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form method="POST" action="CreateComputer">
                        ...
                        <div class="actions pull-right">
                            ...
                            or
                            <a href="/Computer-database/ComputerMenu?nombre=10&page=1&sort=asc&search=" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
